locals {
  ...
  project_signature_clean_28 = length(local.project_signature_clean) > 28 ? substr(local.project_signature_clean,length(local.project_signature_clean)-28,28) : local.project_signature_clean
